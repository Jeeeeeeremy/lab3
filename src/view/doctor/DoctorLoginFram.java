 ...
 * @author Gulinigeer
 */
public class DoctorLoginFram extends javax.swing.JFrame {
     ...
     */
    public DoctorLoginFram() {
        initComponents();
    }

    public DoctorLoginFram(List<Patient> patients, HashMap<String, ArrayList<Doctor>> hospitals, HashMap<String,ArrayList<String>> communityDirectory, HashMap<String, ArrayList<String>> cityDirectory, HashMap<String,ArrayList<String>> ComToPatients) {
    ...
    private void initComponents() {
        ...
        userTypeItem.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"Doctor"}));
